...
module.exports = class enUSLang extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_DAILY_FROMNOW: giver => `<:tickNo:373304949234204682> You cannot claim your daily credits yet, please try again in ${moment(giver.reputationTimer).fromNow(true)}.`,
