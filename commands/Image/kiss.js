...
module.exports = class KissImage extends Command {
	...
	async run(msg, [mentioned = msg.author]) {
		const action = mentioned === msg.author ? msg.language.get('USER_REACTION_SOLO', msg.author.toString(), 'kiss') : msg.language.get('USER_REACTION', msg.author.toString(), mentioned.toString(), 'kissed');
