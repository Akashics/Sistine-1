...
module.exports = class extends Command {
	...
	async run(msg) {
		...
		return msg.channel.send('', { embed: { color: 0x36393E, author: { name: 'Meme', iconURL: msg.author.displayAvatarURL() }, image: { url: imageMemes[Math.floor(Math.random() * (imageMemes.length - 1))] } } });
	}
