/* ! jQuery v3.2.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function (a, b) {
	...
	r.fn = r.prototype = {
		...
		var a, b, c, d, e, f, g = arguments[0] || {},
			...
			i = arguments.length,
			j = !1;
		for (typeof g === 'boolean' && (j = g, g = arguments[h] || {}, h++), typeof g === 'object' || r.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++) {
			if ((a = arguments[h]) != null) { for (b in a) c = g[b], d = a[b], g !== d && (j && d && (r.isPlainObject(d) || (e = Array.isArray(d))) ? (e ? (e = !1, f = c && Array.isArray(c) ? c : []) : f = c && r.isPlainObject(c) ? c : {}, g[b] = r.extend(j, f, d)) : void 0 !== d && (g[b] = d)); }
		}
		return g;
	}, r.extend({
		...
		isPlainObject: function (a) {
			var b, c;
			return !(!a || k.call(a) !== '[object Object]') && (!(b = e(a)) || (c = l.call(b, 'constructor') && b.constructor, typeof c === 'function' && m.call(c) === n));
		},
		...
		makeArray: function (a, b) {
			var c = b || [];
			return a != null && (w(Object(a)) ? r.merge(c, typeof a === 'string' ? [a] : a) : h.call(c, a)), c;
		},
		...
		map: function (a, b, c) {
			var d, e, f = 0,
				h = [];
			if (w(a)) { for (d = a.length; f < d; f++) e = b(a[f], f, c), e != null && h.push(e); } else { for (f in a) e = b(a[f], f, c), e != null && h.push(e); }
			return g.apply([], h);
		},
		guid: 1,
		proxy: function (a, b) {
			var c, d, e;
			if (typeof b === 'string' && (c = a[b], b = a, a = c), r.isFunction(a)) {
	...
	function w(a) {
		var b = !!a && 'length' in a && a.length,
			c = r.type(a);
		return c !== 'function' && !r.isWindow(a) && (c === 'array' || b === 0 || typeof b === 'number' && b > 0 && b - 1 in a);
	}
	var x = (function (a) {
		...
		function la(a, b) {
			var c = b && a,
				d = c && a.nodeType === 1 && b.nodeType === 1 && a.sourceIndex - b.sourceIndex;
			if (d) return d;
			if (c) {
		...
		c = ga.support = {}, f = ga.isXML = function (a) {
			...
			return g !== n && g.nodeType === 9 && g.documentElement ? (n = g, o = n.documentElement, p = !f(n), v !== n && (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener('unload', da, !1) : e.attachEvent && e.attachEvent('onunload', da)), c.attributes = ja((a) => a.className = 'i', !a.getAttribute('className')), c.getElementsByTagName = ja((a) => a.appendChild(n.createComment('')), !a.getElementsByTagName('*').length), c.getElementsByClassName = Y.test(n.getElementsByClassName), c.getById = ja((a) => o.appendChild(a).id = u, !n.getElementsByName || !n.getElementsByName(u).length), c.getById ? (d.filter.ID = function (a) {
				...
				return function (a) {
					...
					o.appendChild(a).innerHTML = `<a id='${u}'></a><select id='${u}-\r\\' msallowcapture=''><option selected=''></option></select>`, a.querySelectorAll("[msallowcapture^='']").length && q.push(`[*^$]=${K}*(?:''|"")`), a.querySelectorAll('[selected]').length || q.push(`\\[${K}*(?:value|${J})`), a.querySelectorAll(`[id~=${u}-]`).length || q.push('~='), a.querySelectorAll(':checked').length || q.push(':checked'), a.querySelectorAll(`a#${u}+*`).length || q.push('.#.+[+~]');
						...
						b.setAttribute('type', 'hidden'), a.appendChild(b).setAttribute('name', 'D'), a.querySelectorAll('[name=d]').length && q.push(`name${K}*[*^$|!~]?=`), a.querySelectorAll(':enabled').length !== 2 && q.push(':enabled', ':disabled'), o.appendChild(a).disabled = !0, a.querySelectorAll(':disabled').length !== 2 && q.push(':enabled', ':disabled'), a.querySelectorAll('*,:x'), q.push(',.*:');
			...
			filter: {
				...
				CLASS: function (a) {
					var b = y[`${a} `];
					return b || (b = new RegExp(`(^|${K})${a}(${K}|$)`)) && y(a, (a) => b.test(typeof a.className === 'string' && a.className || typeof a.getAttribute !== 'undefined' && a.getAttribute('class') || ''));
				},
				ATTR: function (a, b, c) {
					return function (d) {
						var e = ga.attr(d, a);
					...
					return d === 1 && e === 0 ? function (a) {
						...
						if (q) {
							...
							if (o = [g ? q.firstChild : q.lastChild], g && s) {
								...
								while (m = ++n && m && m[p] || (t = n = 0) || o.pop()) { if ((h ? m.nodeName.toLowerCase() === r : m.nodeType === 1) && ++t && (s && (l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), k[a] = [w, t]), m === b)) break; }
							}
			...
			pseudos: {
				...
				contains: ia((a) => a = a.replace(_, aa),
					(b) => (b.textContent || b.innerText || e(b)).indexOf(a) > -1),
				lang: ia((a) => U.test(a || '') || ga.error(`unsupported lang: ${a}`), a = a.replace(_, aa).toLowerCase(),
					(b) => {
						var c;
						do { if (c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')) return c = c.toLowerCase(), c === a || c.indexOf(`${a }-`) === 0; } while ((b = b.parentNode) && b.nodeType === 1);
						return !1;
					}),
				target: function (b) {
		...
		return h = ga.compile = function (a, b) {
			...
			var f, i, j, k, l, m = typeof a === 'function' && a,
	...
	function E(a, b, c) {
		return r.isFunction(b) ? r.grep(a, (a, d) => !!b.call(a, d, a) !== c) : b.nodeType ? r.grep(a, (a) => a === b !== c) : typeof b !== 'string' ? r.grep(a, (a) => i.call(b, a) > -1 !== c) : D.test(b) ? r.filter(b, a, c) : (b = r.filter(b, a), r.grep(a, (a) => i.call(b, a) > -1 !== c && a.nodeType === 1));
	}
	r.filter = function (a, b, c) {
		var d = b[0];
		return c && (a = `:not(${a})`), b.length === 1 && d.nodeType === 1 ? r.find.matchesSelector(d, a) ? [d] : [] : r.find.matches(a, r.grep(b, (a) => a.nodeType === 1));
	}, r.fn.extend({
		find: function (a) {
	...
	function P(a, b, c, d) {
		var e;
		try {
			a && r.isFunction(e = a.promise) ? e.call(a).done(b).fail(c) : a && r.isFunction(e = a.then) ? e.call(a, b, c) : b(...[a].slice(d));
		} catch (a) {
			c.apply(void 0, [a]);
		}
	}
	r.extend({
								...
								var h = this,
									...
									j = function () {
										...
										if (!(b < f)) {
											...
											j = a && (typeof a === 'object' || typeof a === 'function') && a.then, r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [a]), (e || c.resolveWith)(h, i));
										}
									},
									k = e ? j : function () {
										try {
		...
		when: function (a) {
			...
			if (b <= 1 && (P(a, g.done(h(c)).resolve, g.reject, !b), g.state() === 'pending' || r.isFunction(e[c] && e[c].then))) return g.then();
	...
	V.uid = 1, V.prototype = {
		...
		set: function (a, b, c) {
			...
			if (typeof b === 'string') { e[r.camelCase(b)] = c; } else { for (d in b) e[r.camelCase(d)] = b[d]; }
			return e;
		},
		get: function (a, b) {
	...
	function _(a, b, c) {
		...
		if (void 0 === c && a.nodeType === 1) {
			if (d = `data-${b.replace(Z, '-$&').toLowerCase()}`, c = a.getAttribute(d), typeof c === 'string') {
				try {
					c = $(c);
				} catch (e) {}
				X.set(a, b, c);
	...
	function fa(a, b, c, d) {
		var e, f = 1,
			...
			k = (r.cssNumber[b] || j !== 'px' && +i) && ba.exec(r.css(a, b));
		if (k && k[3] !== j) {
			j = j || k[3], c = c || [], k = +i || 1;
			do f = f || '.5', k /= f, r.style(a, b, k + j); while (f !== (f = h() / i) && f !== 1 && --g);
		}
	...
	function ha(a) {
		var b, c = a.ownerDocument,
			d = a.nodeName,
			e = ga[d];
		return e ? e : (b = c.body.appendChild(c.createElement(d)), e = r.css(b, 'display'), b.parentNode.removeChild(b), e === 'none' && (e = 'block'), ga[d] = e, e);
	}
	...
	function na(a, b) {
		var c;
		return c = typeof a.getElementsByTagName !== 'undefined' ? a.getElementsByTagName(b || '*') : typeof a.querySelectorAll !== 'undefined' ? a.querySelectorAll(b || '*') : [], void 0 === b || b && B(a, b) ? r.merge([a], c) : c;
	}
	...
	function qa(a, b, c, d, e) {
		for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++) {
			if (f = a[n], f || f === 0) {
				if (r.type(f) === 'object') { r.merge(m, f.nodeType ? [f] : f); } else if (pa.test(f)) {
	...
	r.event = {
		...
		which: function (a) {
			var b = a.button;
			return a.which == null && sa.test(a.type) ? a.charCode != null ? a.charCode : a.keyCode : !a.which && void 0 !== b && ta.test(a.type) ? 1 & b ? 1 : 2 & b ? 3 : 4 & b ? 2 : 0 : a.which;
		}
	...
	r.extend({
		...
		clone: function (a, b, c) {
			...
			if (b) {
				if (c) { for (f = f || na(a), g = g || na(h), d = 0, e = f.length; d < e; d++) Ha(f[d], g[d]); } else { Ha(a, h); }
			}
		...
		empty: function () {
			for (var a, b = 0; (a = this[b]) != null; b++) a.nodeType === 1 && (r.cleanData(na(a, !1)), a.textContent = '');
			return this;
		},
		clone: function (a, b) {
		...
		html: function (a) {
			return T(this, function (a) {
				...
				if (typeof a === 'string' && !Aa.test(a) && !ma[(ka.exec(a) || ['', ''])[1].toLowerCase()]) {
					a = r.htmlPrefilter(a);
					try {
						for (; c < d; c++) b = this[c] || {}, b.nodeType === 1 && (r.cleanData(na(b, !1)), b.innerHTML = a);
						b = 0;
					} catch (e) {}
				}
	...
	!(function () {
		function b() {
			if (i) {
				...
				c = b.top !== '1%', g = b.marginLeft === '2px', e = b.width === '4px', i.style.marginRight = '50%', f = b.marginRight === '4px', ra.removeChild(h), i = null;
			}
		}
	...
	function $a(a, b, c) {
		var d, e = Na(a),
			f = Oa(a, b, e),
			g = r.css(a, 'boxSizing', !1, e) === 'border-box';
	...
	r.extend({
		...
		r.cssHooks[b] = {
			get: function (a, c, d) {
				if (c) {
					return !Qa.test(r.css(a, 'display')) || a.getClientRects().length && a.getBoundingClientRect().width ? $a(a, b, d) : ea(a, Sa, () => $a(a, b, d));
				}
			},
			set: function (a, c, d) {
				var e, f = d && Na(a),
					g = d && Za(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f);
				return g && (e = ba.exec(c)) && (e[3] || 'px') !== 'px' && (a.style[b] = c, c = r.css(a, b)), Ya(a, c, g);
			}
		};
	}), r.cssHooks.marginLeft = Pa(o.reliableMarginLeft, (a, b) => {
		if (b) {
			return `${parseFloat(Oa(a, 'marginLeft')) || a.getBoundingClientRect().left - ea(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)}px`;
		}
	}), r.each({
		margin: '',
		padding: '',
		...
		r.cssHooks[a + b] = {
			expand: function (c) {
				for (var d = 0, e = {}, f = typeof c === 'string' ? c.split(' ') : [c]; d < 4; d++) e[a + ca[d] + b] = f[d] || f[d - 2] || f[0];
				return e;
			}
	...
	r.Tween = _a, _a.prototype = {
		...
		_default: {
			get: function (a) {
				var b;
				return a.elem.nodeType !== 1 || a.elem[a.prop] != null && a.elem.style[a.prop] == null ? a.elem[a.prop] : (b = r.css(a.elem, a.prop, ''), b && b !== 'auto' ? b : 0);
			},
			set: function (a) {
	...
	function ib(a, b, c) {
		...
		if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
			l && a.nodeType === 1 && (c.overflow = [o.overflow, o.overflowX, o.overflowY], j = q && q.display, j == null && (j = W.get(a, 'display')), k = r.css(a, 'display'), k === 'none' && (j ? k = j : (ia([a], !0), j = a.style.display || j, k = r.css(a, 'display'), ia([a]))), (k === 'inline' || k === 'inline-block' && j != null) && r.css(a, 'float') === 'none' && (i || (m.done(() => {
				o.display = j;
			}), j == null && (k = o.display, j = k === 'none' ? '' : k)), o.display = 'inline-block')), c.overflow && (o.overflow = 'hidden', m.always(() => {
				o.overflow = c.overflow[0], o.overflowX = c.overflow[1], o.overflowY = c.overflow[2];
			})), i = !1;
			for (d in n) {
				i || (q ? 'hidden' in q && (p = q.hidden) : q = W.access(a, 'fxshow', { display: j }), f && (q.hidden = !p), p && ia([a], !0), m.done(() => {
	...
	(function () {
		...
		a.type = 'checkbox', o.checkOn = a.value !== '', o.optSelected = c.selected, a = d.createElement('input'), a.value = 't', a.type = 'radio', o.radioValue = a.value === 't';
	}());
	...
	r.fn.extend({
		...
		hasClass: function (a) {
			var b, c, d = 0;
			b = ` ${a} `;
			while (c = this[d++]) { if (c.nodeType === 1 && ` ${pb(qb(c))} `.indexOf(b) > -1) return !0; }
			return !1;
		}
	});
	var rb = /\r/g;
			...
			var b, c, d, e = this[0]; {
				if (arguments.length) {
					return d = r.isFunction(a), this.each(function (c) {
						var e;
						this.nodeType === 1 && (e = d ? a.call(this, c, r(this).val()) : a, e == null ? e = '' : typeof e === 'number' ? e += '' : Array.isArray(e) && (e = r.map(e, (a) => a == null ? '' : `${a}`)), b = r.valHooks[this.type] || r.valHooks[this.nodeName.toLowerCase()], b && 'set' in b && void 0 !== b.set(this, e, 'value') || (this.value = e));
					});
				}
				if (e) return b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()], b && 'get' in b && void 0 !== (c = b.get(e, 'value')) ? c : (c = e.value, typeof c === 'string' ? c.replace(rb, '') : c == null ? '' : c);
			}
		}
	}), r.extend({
		valHooks: {
	...
	function Ab(a, b, c, d) {
		...
		if (Array.isArray(b)) {
			r.each(b, (b, e) => {
				c || wb.test(a) ? d(a, e) : Ab(`${a}[${typeof e === 'object' && e != null ? b : ''}]`, e, c, d);
			});
		} else if (c || r.type(b) !== 'object') { d(a, b); } else { for (e in b) Ab(`${a}[${e}]`, b[e], c, d); }
	}
	r.param = function (a, b) {
		...
		serializeArray: function () {
			return this.map(function () {
				...
				var c = r(this).val();
				return c == null ? null : Array.isArray(c) ? r.map(c, (a) => ({
					name: b.name,
					value: a.replace(xb, '\r\n')
				})) : {
					name: b.name,
 ...
 if (g && a.throws) { b = g(b); } else { try {
	...
	r.extend({
		...
		ajax: function (b, c) {
			...
			var e, f, g, h, i, j, k, l, m, n, o = r.ajaxSetup({}, c),
				...
				y = {
					...
					statusCode: function (a) {
						var b;
						if (a) {
							if (k) { y.always(a[y.status]); } else { for (b in a) u[b] = [u[b], a[b]]; }
						}
						return this;
					},
					abort: function (a) {
			...
			if (s.promise(y), o.url = `${b || o.url || tb.href}`.replace(Hb, `${tb.protocol}//`), o.type = c.method || c.type || o.method || o.type, o.dataTypes = (o.dataType || '*').toLowerCase().match(L) || [''], o.crossDomain == null) {
				j = d.createElement('a');
				try {
		...
		if (o.cors || Sb && !b.crossDomain) {
			return {
				send: function (e, f) {
					...
					c = function (a) {
						return function () {
							c && (c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, a === 'abort' ? h.abort() : a === 'error' ? typeof h.status !== 'number' ? f(0, 'error') : f(h.status, h.statusText) : f(Rb[h.status] || h.status, h.statusText, (h.responseType || 'text') !== 'text' || typeof h.responseText !== 'string' ? { binary: h.response } : { text: h.responseText }, h.getAllResponseHeaders()));
						};
	...
	r.ajaxSetup({
		...
		var e, f, g, h = b.jsonp !== !1 && (Ub.test(b.url) ? 'url' : typeof b.data === 'string' && (b.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && Ub.test(b.data) && 'data');
		...
		var d, e, f, g = this,
			h = a.indexOf(' ');
		return h > -1 && (d = pb(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, b = void 0) : b && typeof b === 'object' && (e = 'POST'), g.length > 0 && r.ajax({
			url: a,
			type: e || 'GET',
			dataType: 'html',
			data: b
		...
		position: function () {
			if (this[0]) {
				...
				return r.css(c, 'position') === 'fixed' ? b = c.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), B(a[0], 'html') || (d = a.offset()), d = {
		...
		r.each({
			...
			r.fn[d] = function (e, f) {
				...
				return T(this, (b, c, e) => {
					var f;
					return r.isWindow(b) ? d.indexOf('outer') === 0 ? b[`inner${a}`] : b.document.documentElement[`client${a}`] : b.nodeType === 9 ? (f = b.documentElement, Math.max(b.body[`scroll${a}`], f[`scroll${a}`], b.body[`offset${a}`], f[`offset${a}`], f[`client${a}`])) : void 0 === e ? r.css(b, c, h) : r.style(b, c, e, h);
				}, b, g ? e : void 0, g);
			};
		});
	}), r.fn.extend({
	...
	}, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, typeof define === 'function' && define.amd && define('jquery', [], () => r);
	var Vb = a.jQuery,
		Wb = a.$;
