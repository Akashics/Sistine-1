...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			RATE_WAIFU: (waifu, rate) => `I'd give ${waifu} a ${rate}/10!`,
			...
			MUSIC_ADDED_QUEUE: song => `:musical_note: \` ${song.title} \` was added to the guild queue.`,
			MUSIC_PLAY: song => `:musical_note: Playing: \` ${song.title} \` as requested by: \`${song.requester.tag} \``,
			MUSIC_AUTOPLAY: (author, enabled) => `:musical_note: YouTube AutoPlay has been ${enabled ? 'enabled' : 'disabled'} by ${author.tag}.`,
			MUSIC_USER_NOVOICE: ':musical_note: You are not connected to a voice channel.',
			MUSIC_NOCONNECT: ':musical_note: I do not have enough permissions to connect to your voice channel.',
			MUSIC_NOSPEAK: ':musical_note: I can connect... but not speak. Please turn on this permission so I can emit music.',
