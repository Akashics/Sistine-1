...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			MUSIC_PAUSED: author => `🔊 Music was paused by ${author}.`,
			MUSIC_ALREADYPAUSED: '🔊 The stream is already paused.',
			MUSIC_ERR: err => `🔊 Something weird happened. - ${err}`,
			MUSIC_NOTPLAYING: status => `Not currently playing anything. Status: ${status}.`,
			MUSIC_NOTDJ: 'You can\'t execute this command when there are over 4 members. You must be at least a DJ Member.',
